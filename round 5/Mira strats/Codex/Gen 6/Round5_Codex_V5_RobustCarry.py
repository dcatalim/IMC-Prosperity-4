...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if gross:
            # Keep the highest-confidence assets always on; only add the broad carry book
            # once its own live paper PnL confirms the round is in the known momentum regime.
            open_threshold = max(1200.0, 45.0 * gross)
