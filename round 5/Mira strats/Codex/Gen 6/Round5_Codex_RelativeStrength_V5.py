...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if gross:
            # Faster gate than the carry book because the always-on relative basket is
            # intentionally tighter and already filters the worst early drawdown names.
            open_threshold = max(1200.0, 38.0 * gross)
