...
class Trader:
    ...
    def hydro_orders(
        ...
        reservation = fair - 0.030 * position
        orders.extend(
            self.make_quotes(
                self.HYDRO,
                book,
    ...
    def velvet_orders(
        ...
        take_edge = self.clamp(3.5 + 0.75 * book["spread"] + 1.20 * mad, 5.0, 11.0)
        ...
        reservation = fair - 0.060 * position
        orders.extend(
            self.make_quotes(
                self.VELVET,
                book,
    ...
    def voucher_orders(
        ...
        reservation = fair - 0.035 * position
        orders.extend(
            self.make_quotes(
                symbol,
                book,
